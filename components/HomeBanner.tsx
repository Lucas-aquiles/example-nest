...
const HomeBanner = ({data}: HomeBannerProps) => {
  ...
  <BackgroundPage image={images || null} heightContainer="h-150"  col="1"
        row="2"
        span="1">
  ...
  <div className="mt-4 mb-8 sm:mt-2 sm:mb-auto sm:mx-4 sm:ml-6">
    {
      data &&    <Button className=" w-full sm:w-auto text-3xl font-bold">{data.suscribeNow.buttonText}</Button>
