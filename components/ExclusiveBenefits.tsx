...
const ExclusiveBenefits = ({data}: any) => {
  ...
  return (
      ...
      <div className="mx-auto flex max-w-screen-lg flex-col items-center lg:flex-row lg:justify-between">
        ...
        <div className="mt-8 flex w-full flex-col gap-4 pl-9 lg:mt-0 lg:w-1/2 lg:flex-row">
          {data.card01?.isActive && (
            <div className="relative mb-4 flex w-full flex-col items-center lg:mb-0 lg:w-1/2 z-10">
          ...
          {data.card02?.isActive && (
            <div className="relative flex w-full flex-col items-center lg:w-1/2 z-10">
              <Card className="flex h-[420px] w-full flex-col items-center bg-cardBackground p-4">
                <div className="mb-3 flex w-full justify-center">
                  <ImageContainer
                    image={image}
    ...
    <div className="absolute inset-x-0 bottom-0 h-[200px] bg-gradient-to-b from-transparent to-[#1c4e36] z-0"></div>
  </div>
