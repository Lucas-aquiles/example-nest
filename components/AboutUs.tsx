  ...
  const AboutUs = ({data}: any) => {
    ...
    return (
      <div className="inset-0 h-auto bg-black	 py-9 ">
        <div className=' flex'>
          <div className="mx-auto flex w-11/12 max-w-screen-lg flex-col items-center sm:flex-row sm:w-3/4">
            <ImageContainer
              image={image}
              className="h-[150px] w-full sm:h-[500px] sm:w-[500px] flex-shrink-0"
